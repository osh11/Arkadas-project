 ...
 */
@WebServlet("/QnaNoticeCommentForm.no")
public class QnaNoticeCommentFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaNoticeCommentFormServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(qnaNotice != null) {
			...
			page = "views/notice/qnanotice/QnaNoticeComment.jsp";
		}else {
