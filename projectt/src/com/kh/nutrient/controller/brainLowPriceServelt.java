...
/**
 * Servlet implementation class brainLowPriceServelt
 */
@WebServlet("/brainLowPrice.nu")
public class brainLowPriceServelt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public brainLowPriceServelt() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectBrLowPrice();
