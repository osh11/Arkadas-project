...
/**
 * Servlet implementation class nutrientHighPriceServlet
 */
@WebServlet("/nutrientHighPrice.nu")
public class nutrientHighPriceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public nutrientHighPriceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectNuHighPrice();
