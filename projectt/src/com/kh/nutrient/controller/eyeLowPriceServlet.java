...
/**
 * Servlet implementation class eyeLowPriceServlet
 */
@WebServlet("/eyeLowPrice.nu")
public class eyeLowPriceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public eyeLowPriceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectEyLowPrice();
