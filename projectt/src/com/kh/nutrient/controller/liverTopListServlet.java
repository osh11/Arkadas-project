...
/**
 * Servlet implementation class liverTopListServlet
 */
@WebServlet("/liverTopList.nu")
public class liverTopListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public liverTopListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectNuLiTopList();
