...
/**
 * Servlet implementation class liverHighPriceServlet
 */
@WebServlet("/liverHighPrice.nu")
public class liverHighPriceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public liverHighPriceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectLiHighPrice();
