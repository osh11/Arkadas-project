...
/**
 * Servlet implementation class toothLowPirceServlet
 */
@WebServlet("/toothLowPrice.nu")
public class toothLowPriceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public toothLowPriceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectToLowPrice();
