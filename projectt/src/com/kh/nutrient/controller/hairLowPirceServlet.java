...
/**
 * Servlet implementation class hairLowPirceServlet
 */
@WebServlet("/hairLowPirce.nu")
public class hairLowPirceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public hairLowPirceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectHaLowPrice();
