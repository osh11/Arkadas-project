...
/**
 * Servlet implementation class brainTopListServlet
 */
@WebServlet("/brainTopList.nu")
public class brainTopListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public brainTopListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectNuBrTopList();
