...
/**
 * Servlet implementation class nutirentListServlet
 */
@WebServlet("/list.nu")
public class nutirentListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public nutirentListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Board> list = new nutrientBoardService().selectNuList();
