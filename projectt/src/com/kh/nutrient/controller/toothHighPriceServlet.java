...
/**
 * Servlet implementation class toothHighPriceServlet
 */
@WebServlet("/toothHighPrice.nu")
public class toothHighPriceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public toothHighPriceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectToHighPrice();
