...
/**
 * Servlet implementation class eyeTopListServlet
 */
@WebServlet("/eyeTopList.nu")
public class eyeTopListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public eyeTopListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Board> list = new nutrientBoardService().selectNuEyTopList();
