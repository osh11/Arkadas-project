...
<body>
	...
	<div class="outer">
		...
		<h2 align="center" style="color:red;">공지사항 작성하기</h2>
		
		<form id="enrollForm" action="<%=request.getContextPath()%>/MainNoticeReg.no" method="post" >
			<table id="enrollForm" border="1" align="center">
				<tr style="display:none;">
					<td colspan="4" style="width:530px;"><input type="text" name="user" value="권석호"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4">
						<textarea name="content" cols="75" rows="20" style="resize:none;"></textarea>
					</td>
				</tr>	
			</table>
			<br>
