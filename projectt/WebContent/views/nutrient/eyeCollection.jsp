                   ...
                   <input id="keyword" name="keyword" type="text">
					...
					<ul id="lookOp">
						<li class="lookOpSel" id="lookOpSel1"><a
							href="<%=request.getContextPath()%>/eyeTopList.nu">인기순</a></li>
						<li>/</li>
						<li class="lookOpSel" id="lookOpSel2"><a href="<%=request.getContextPath()%>/eyeHighPrice.nu">낮은 가격순</a></li>
						<li>/</li>
						<li class="lookOpSel" id="lookOpSel3"><a href="<%=request.getContextPath()%>/eyeLowPrice.nu">높은 가격순</a></li>
					</ul>
