                   ...
                   <input id="keyword" name="keyword" type="text">
					...
					<ul id="lookOp">
						<li class="lookOpSel" id="lookOpSel1"><a
							href="<%=request.getContextPath()%>/toothTopList.nu">인기순</a></li>
						<li>/</li>
						<li class="lookOpSel" id="lookOpSel2"><a href="<%=request.getContextPath()%>/toothHighPrice.nu">낮은 가격순</a></li>
						<li>/</li>
						<li class="lookOpSel" id="lookOpSel3"><a href="<%=request.getContextPath()%>/toothLowPrice.nu">높은 가격순</a></li>
					</ul>
