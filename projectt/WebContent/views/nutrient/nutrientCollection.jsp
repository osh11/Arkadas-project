               ...
               <fieldset>
				...
				<ul id="lookOp">
					<li class="lookOpSel" id="lookOpSel1"><a
						href="<%=request.getContextPath()%>/topList.nu">인기순</a></li>
					<li>/</li>
					<li class="lookOpSel" id="lookOpSel2"><a
						href="<%=request.getContextPath()%>/nutrientHighPrice.nu">낮은
							가격순</a></li>
					<li>/</li>
					<li class="lookOpSel" id="lookOpSel3"><a
						href="<%=request.getContextPath()%>/nutrientLowPrice.nu">높은
							가격순</a></li>
				</ul>
				<br> <br>
				...
				<div class="listArea">
					...
					<div class="thumbnail">
						...
						<img src="<%=request.getContextPath()%>/resources/board_upfiles/<%=b.getTitleImg()%>" width="200px" height="200px"> <br>
						<p id="kk">
